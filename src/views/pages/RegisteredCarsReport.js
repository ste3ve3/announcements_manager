import {
  ...
  const RegisteredCarsReport = () => {
    ...
    const { data, isError, isLoading } = useFetcher(
      `/registercar?cleared=false&perPage=1000000&date=${JSON.stringify(date)}`
    );
    ...
    const exportPDF = () => {
      ...
      doc.text(
        `MAGERWA VCC REGISTERED CARS FOR ${
    ...
    return (
      <>
        ...
        <Container>
          ...
          >
            <Typography variant="h4">Registered Cars Report</Typography>
          </Stack>
  ...
  export default RegisteredCarsReport;